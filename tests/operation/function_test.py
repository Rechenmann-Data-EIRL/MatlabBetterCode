import unittest
from core.operation.function import Function, find_function_parameters_from_line
...
class FunctionTestCase(unittest.TestCase):
    def test_creation(self):
        ...
        function = Function(size, name="functionName", arguments=["arg1", "arg2"], outputs=[],
                                                              parent=None)
        ...
        self.assertEqual(0, len(function.functions))
        self.assertEqual(None, function.parent)

    def test_creation_from_line(self):
        line = "function ...\r\n\t[output1, ...\n\toutput2  ] = ...\n\ttestFunction  (argument1,...\n\targument2)"
        function = Function.create_from_line(line, parent=None, line_index=0)
    ...
    def test_add_operation(self):
        ...
        function = Function(size1, name="functionName", parent=None)
        operation = Function(size2, name="nestedFunction", parent=function)
    ...
    def test_finding_function_name_arguments_and_spaces(self):
        parameters = find_function_parameters_from_line("function  testFunction  (argument1, argument2)")
        self.assertEqual("testFunction", parameters["name"])
    ...
    def test_finding_function_output_with_arguments_and_spaces(self):
        parameters = find_function_parameters_from_line(
    ...
    def test_finding_function_multiple_outputs_with_arguments_and_spaces(self):
        ...
        parameters = find_function_parameters_from_line(string)
        self.assertEqual("testFunction", parameters["name"])
        self.assertEqual(["argument1", "argument2"], parameters["arguments"])
    ...
    def test_if_line_is_function(self):
        string = "function [output1, output2  ] = testFunction  (argument1, argument2)"
        self.assertEqual(True, Function.is_line_function(string))

    def test_if_line_is_not_a_function(self):
        string = "[output1, output2  ] = testFunction  (argument1, argument2)"
        self.assertEqual(False, Function.is_line_function(string))
